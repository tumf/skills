...
- Add top-level `sanity_checks` entries when you want the report to include explicit top-down, capacity, budget, or benchmark checks alongside the script's built-in checks
