...
description: デジタル庁のダッシュボードデザイン実践ガイドブックに基づく、見やすいダッシュボード設計・作成のガイド。ダッシュボードを作る・改善する・レビューする時に使う。グラフ選び、レイアウト、カラーパレット、アクセシビリティ、チェックリストを網羅。軽量HTML、Grafana、SQLiteベースのダッシュボード作成時にも適用可能。
---
